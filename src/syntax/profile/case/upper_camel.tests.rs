...
mod traits {
    ...
    #[test]
    fn is_chunk_char() {
        assert!(UpperCamel::<Ascii>::is_chunk_char('A'));
        assert!(UpperCamel::<Ascii>::is_chunk_char('a'));
        assert!(UpperCamel::<Ascii>::is_chunk_char('1'));
        assert!(!UpperCamel::<Ascii>::is_chunk_char(' '));
    }
    ...
    fn is_ident_start_char() {
        assert!(UpperCamel::<Ascii>::is_ident_start_char('A'));
        assert!(!UpperCamel::<Ascii>::is_ident_start_char('a'));
        assert!(!UpperCamel::<Ascii>::is_ident_start_char('1'));
        assert!(!UpperCamel::<Ascii>::is_ident_start_char(' '));
    }
}
