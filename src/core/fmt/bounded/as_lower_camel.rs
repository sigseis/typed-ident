...
impl_displayable_type! {
    ...
    upper=false,
    docs=concat!(
        "A `Display` type for the [`AsLowerCamel`] trait in plain form.",
        "\n\n",
        "This type is constructed by calling one of the [`as_lower_camel`] methods.",
        "\n\n",
        "[`as_lower_camel`]: AsLowerCamel::as_lower_camel"
    ),
}
...
impl_displayable_type! {
    ...
    upper=false,
    docs=concat!(
        "A `Display` type for the [`AsLowerCamel`] trait in canonical form.",
        "\n\n",
...
impl_displayable_type! {
    ...
    upper=false,
    docs=concat!(
        "A `Display` type for the [`AsLowerCamel`] trait in decorated form.",
        "\n\n",
...
impl_displayable_type! {
    ...
    upper=false,
    docs=concat!(
        "A `Display` type for the [`AsLowerCamel`] trait in delimited form.",
        "\n\n",
...
pub trait AsLowerCamel {
    ...
    /// [`as_lower_camel_canonical`] for a version that would validate this).
    ///
    ...
    fn as_lower_camel(&self) -> LowerCamel<'_> {
        self.as_lower_camel_opts::<Default>()
    }
    ...
    ///         .as_lower_camel_opts::<AllBoundaries>()
    ///         .to_string(),
    ...
    ///         .as_lower_camel_opts::<NoBoundaries>()
    ///         .to_string(),
    ...
    /// could be considered a valid identifier (see [`as_lower_camel`] for a
